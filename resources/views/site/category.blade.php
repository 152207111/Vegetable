    ...
    <div class="product-detail">
      ...
      <div class="product">
        <div class="image">
          ...
          <img src="{{ asset('site/image/	Capsicum.webp')}}" alt="">
        </div>
        <div class="content">
          <div class="product-top">
            <h2>100% Fresh <span class="rate">4.8<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
    ...
    <div class="product-detail">
      ...
      <div class="product">
        <div class="image">
          ...
          <img src="{{ asset('site/image/Grapes.webp')}}" alt="">
        </div>
        <div class="content">
          <div class="product-top">
            <h2>100% Fresh <span class="rate">4.7<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
    ...
    <div class="product-detail">
      ...
      <div class="product">
        <div class="image">
          ...
          <img src="{{ asset('site/image/Coriander.webp')}}" alt="Cumin image">
        </div>
        <div class="content">
          <div class="product-top">
            <h2>100% Fresh <span class="rate">4.5<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
      ...
      <div class="product">
        <div class="image">
          ...
          <img src="{{ asset('site/image/Garlic.webp')}}" alt="Cumin image">
        </div>
        <div class="content">
          <div class="product-top">
            <h2>100% Fresh <span class="rate">4.5<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
      ...
      <div class="product">
        ...
        <div class="product">
          <div class="image">
            ...
            <img src="{{ asset('site/image/Pistachio.webp')}}" alt="Cumin image">
          </div>
          <div class="content">
            <div class="product-top">
              <h2>100% Fresh <span class="rate">4.4<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
